...
class Workspace:
    ...
    def draw_axes(self):
        ...
        # X-axis ticks
        for i in range(0, xaxis[0] + x_tick_interval, x_tick_interval):
        ...
        # Y-axis ticks
        for i in range(0, yaxis[1] + y_tick_interval, y_tick_interval):
        ...
        # Z-axis ticks
        for i in range(0, zaxis[2] + z_tick_interval, z_tick_interval):
